...
/**
 * Clase que representa una fábrica para crear instancias de Raton.
 * Extiende de MascotaFactory y proporciona la implementación específica
 * para crear un Raton en un escenario dado.
 */
public class RatonFactory extends MascotaFactory {

    /**
     * Método que crea una mascota de tipo Raton en el escenario proporcionado.
     *
     ...
     * @throws TipoIncorrectoException Si el escenario no puede alojar un Raton.
     */
    @Override
